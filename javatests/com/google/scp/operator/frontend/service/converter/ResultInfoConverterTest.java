...
public final class ResultInfoConverterTest
    extends ConverterTest<ResultInfo, ResultInfoProto.ResultInfo> {

  @Override
  public ResultInfo getFrom() {
    return JobGenerator.createFakeResultInfoShared();
  }

  @Override
  public ResultInfoProto.ResultInfo getTo() {
    return ServiceJobGenerator.createFakeResultInfo();
  }
