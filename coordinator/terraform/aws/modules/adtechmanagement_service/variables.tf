...
variable "adtech_mgmt_db_arn" {
  description = "ARN of Adtech Management database"
  type        = string
  nullable    = false
}

variable "adtech_mgmt_db_name" {
  description = "Name of Adtech Management database"
  type        = string
  nullable    = false
}
...
variable "adtech_mgmt_storage_bucket_name" {
  description = "Name of the bucket used for retrieving Typescript implementations for Adtech Management lambdas."
  type        = string
  nullable    = false
}
