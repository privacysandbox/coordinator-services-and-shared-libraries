...
module "mpkhs_privatekey_heartbeat_prober" {
  source      = "../common/heartbeat_prober"
  environment = var.environment
  aws_region  = var.aws_region

  heartbeat_name                = "privatekey-heartbeat"
  heartbeat_handler             = "heartbeat/privatekey_heartbeat.handler"
  heartbeat_name_prefix         = "pk"
  heartbeat_source_zip          = var.heartbeat_source_zip != "" ? var.heartbeat_source_zip : "${module.bazel.bazel_bin}/python/mpkhs/aws/privatekey_synthetic/privatekey_heartbeat_pkg.zip"
  heartbeat_timeout_sec         = var.heartbeat_timeout_sec
  heartbeat_schedule_expression = var.heartbeat_schedule_expression

  allowed_assume_role = var.coordinator_role
  ...
  alarms_service_label      = "MPKHSPrivateKey"
}
