...
module "mpkhs_publickey_heartbeat_prober" {
  ...
  heartbeat_name                = "publickey-heartbeat"
  heartbeat_handler             = "heartbeat/publickey_heartbeat.handler"
  heartbeat_name_prefix         = "publickey"
  heartbeat_source_zip          = var.heartbeat_source_zip != "" ? var.heartbeat_source_zip : "${module.bazel.bazel_bin}/python/mpkhs/aws/publickey_synthetic/publickey_heartbeat_pkg.zip"
  ...
  alarms_service_label      = "MPKHSPublicKey"
}
