...
variable "key_encryptor_service_account_unique_id" {
  description = "Unique ID of key generation or key storage service account that will use created keys for encryption"
  type        = string
}
