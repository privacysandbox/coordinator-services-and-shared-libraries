...
function plan_pbs_base() {
    ...
    terraform -chdir=$environment_dir/distributedpbs_base plan -input=false -out=dpbs_base_tfplan_$plan_version_suffix | tee tfplan.dpbs_base_$plan_version_suffix.txt
}
...
function plan_pbs_application() {
    ...
    terraform -chdir=$environment_dir/distributedpbs_application plan -input=false -out=dpbs_app_tfplan_$plan_version_suffix | tee tfplan.dpbs_app_$plan_version_suffix.txt
}
