...
public interface JsonSerializerFacade {
   ...
   */
  String serialize(Object toSerialize) throws JsonSerializerFacadeException;
   ...
   */
  <T> T deserialize(String json, Class<T> valueType) throws JsonSerializerFacadeException;
}
