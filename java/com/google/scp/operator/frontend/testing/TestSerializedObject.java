...
public abstract class TestSerializedObject {
  ...
  public static TestSerializedObject.Builder builder() {
  ...
  public interface Builder {
    ...
    /** Set the timestamp. */
    @JsonProperty("timestamp")
    TestSerializedObject.Builder timestamp(Instant timestamp);

    /** Set the name. */
    @JsonProperty("name")
    TestSerializedObject.Builder name(String name);

    /** Set the address. */
    @JsonProperty("address")
    TestSerializedObject.Builder address(String address);
