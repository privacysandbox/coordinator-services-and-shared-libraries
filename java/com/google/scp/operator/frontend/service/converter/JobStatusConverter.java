 ...
 * com.google.scp.operator.protos.shared.backend.JobStatusProto.JobStatus} and {@link
 * com.google.scp.operator.protos.frontend.api.v1.JobStatusProto.JobStatus}. *
 */
public final class JobStatusConverter
  ...
  @Override
  protected com.google.scp.operator.protos.shared.backend.JobStatusProto.JobStatus doBackward(
      JobStatusProto.JobStatus jobStatus) {
    switch (jobStatus) {
      case UNRECOGNIZED:
        return com.google.scp.operator.protos.shared.backend.JobStatusProto.JobStatus.UNRECOGNIZED;
      case JOB_STATUS_UNKNOWN:
        return com.google.scp.operator.protos.shared.backend.JobStatusProto.JobStatus
            .JOB_STATUS_UNKNOWN;
      case RECEIVED:
        return com.google.scp.operator.protos.shared.backend.JobStatusProto.JobStatus.RECEIVED;
      case IN_PROGRESS:
        return com.google.scp.operator.protos.shared.backend.JobStatusProto.JobStatus.IN_PROGRESS;
      case FINISHED:
        return com.google.scp.operator.protos.shared.backend.JobStatusProto.JobStatus.FINISHED;
      default:
        throw new IllegalArgumentException("Unknown JobStatus:" + jobStatus);
    }
  }
