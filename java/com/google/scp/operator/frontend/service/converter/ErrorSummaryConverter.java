 ...
 * com.google.scp.operator.protos.shared.backend.ErrorSummaryProto.ErrorSummary} and {@link
 * com.google.scp.operator.protos.frontend.api.v1.ErrorSummaryProto.ErrorSummary}. *
 */
public final class ErrorSummaryConverter
  ...
  protected ErrorSummary doForward(
      com.google.scp.operator.protos.shared.backend.ErrorSummaryProto.ErrorSummary errorSummary) {
  ...
  @Override
  protected com.google.scp.operator.protos.shared.backend.ErrorSummaryProto.ErrorSummary doBackward(
      ErrorSummary errorSummary) {
    return com.google.scp.operator.protos.shared.backend.ErrorSummaryProto.ErrorSummary.newBuilder()
        .addAllErrorCounts(
            ImmutableList.copyOf(
                errorSummary.getErrorCountsList().stream()
