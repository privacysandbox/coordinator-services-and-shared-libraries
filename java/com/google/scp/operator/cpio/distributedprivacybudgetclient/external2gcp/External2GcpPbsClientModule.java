 ...
 */
package com.google.scp.operator.cpio.distributedprivacybudgetclient.external2gcp;
...
public class External2GcpPbsClientModule extends DistributedPrivacyBudgetClientModule {
  ...
  public ImmutableList<PrivacyBudgetClient> privacyBudgetClients(
    ...
    HttpRequestInterceptor coordinatorATokenInterceptor =
        GcpHttpInterceptorUtil.createPbsHttpInterceptor(
            coordinatorACredentials, coordinatorAPrivacyBudgetServiceAuthEndpoint);
    HttpRequestInterceptor coordinatorBTokenInterceptor =
        GcpHttpInterceptorUtil.createPbsHttpInterceptor(
            coordinatorBCredentials, coordinatorBPrivacyBudgetServiceAuthEndpoint);
