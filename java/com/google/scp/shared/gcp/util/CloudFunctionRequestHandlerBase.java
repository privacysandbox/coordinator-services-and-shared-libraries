...
/* Base class for Cloud Function Request Handlers. */
public abstract class CloudFunctionRequestHandlerBase<Request, Response>
    implements CloudFunctionRequestHandler {

  private static final Logger logger =
      LoggerFactory.getLogger(CloudFunctionRequestHandlerBase.class);
