...
ami_params_tfvar_file = rule(
    ...
    Example:
      ...
      # bazel build :foo --//operator/terraform/aws/applications/operator-service:ami_name_flag="my-ami-name"
    ...
    attrs = {
        "ami_name_flag": attr.label(
            ...
            default = "//operator/terraform/aws/applications/operator-service:ami_name_flag",
        ),
