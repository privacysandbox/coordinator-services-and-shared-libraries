...
def go_repositories():
    """Auto-generated list of Bazel Gazelle rules that downloads and saves Golang
    modules in Bazel's cache.  To regenerate the list, please refer to the
    documentation at go/README.md
    """
    go_repository(
