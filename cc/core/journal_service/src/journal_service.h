...
class JournalService : public JournalServiceInterface {
 ...
 protected:
  /**
   * @brief Constructs a simple metric instance.
   *
   * @param metrics_instance The pointer of metric instance.
   * @param name The event name used to build the metric name.
  ...
  /// The simple metric instance for journal service recover.
  std::shared_ptr<cpio::client_providers::SimpleMetricInterface>
