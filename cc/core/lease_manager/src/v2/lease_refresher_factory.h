...
/**
 * @copydoc LeaseRefresherFactoryInterface
 */
class LeaseRefresherFactory : public LeaseRefresherFactoryInterface {
 public:
  std::shared_ptr<LeaseRefresherInterface> Construct(
