 ...
 * clients to NoSQLDatabaseService
 *
 */
class NoSQLDatabaseServiceFactoryInterface : public core::ServiceInterface {
 public:
  virtual ~NoSQLDatabaseServiceFactoryInterface() = default;

  /**
   * @brief Creates NoSQLDatabaseClient.
   *
   * @return
   * std::shared_ptr<client_providers::NoSQLDatabaseClientProviderInterface>
   * created NoSQLDatabaseClient.
   */
