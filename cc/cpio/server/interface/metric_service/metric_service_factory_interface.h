 ...
 * clients to MetricService
 *
 */
class MetricServiceFactoryInterface : public core::ServiceInterface {
 public:
  virtual ~MetricServiceFactoryInterface() = default;

  /**
   * @brief Creates MetricClient.
   *
   * @return std::shared_ptr<MetricClientInterface>
   * created MetricClient.
   */
  virtual std::shared_ptr<MetricClientInterface>
