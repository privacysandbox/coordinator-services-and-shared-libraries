 ...
 * clients to QueueService
 *
 */
class QueueServiceFactoryInterface : public core::ServiceInterface {
 public:
  virtual ~QueueServiceFactoryInterface() = default;

  /**
   * @brief Creates QueueClient.
   *
   * @param client_options the queue client options.
