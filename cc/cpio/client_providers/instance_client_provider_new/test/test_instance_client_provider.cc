...
ExecutionResult TestInstanceClientProviderNew::Init() noexcept {
  return SuccessExecutionResult();
}

ExecutionResult TestInstanceClientProviderNew::Run() noexcept {
  return SuccessExecutionResult();
}

ExecutionResult TestInstanceClientProviderNew::Stop() noexcept {
  return SuccessExecutionResult();
}

ExecutionResult
TestInstanceClientProviderNew::GetInstanceDetailsByResourceNameSync(
...
ExecutionResult TestInstanceClientProviderNew::GetCurrentInstanceResourceName(
    AsyncContext<GetCurrentInstanceResourceNameRequest,
                 GetCurrentInstanceResourceNameResponse>& context) noexcept {
  return SuccessExecutionResult();
}

ExecutionResult TestInstanceClientProviderNew::GetTagsByResourceName(
...
ExecutionResult TestInstanceClientProviderNew::GetInstanceDetailsByResourceName(
...
ExecutionResult
TestInstanceClientProviderNew::GetCurrentInstanceResourceNameSync(
