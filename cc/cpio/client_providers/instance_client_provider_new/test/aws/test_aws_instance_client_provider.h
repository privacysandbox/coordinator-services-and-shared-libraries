...
/**
 * @copydoc TestInstanceClientProviderNew.
 */
class TestAwsInstanceClientProviderNew : public TestInstanceClientProviderNew {
 public:
  explicit TestAwsInstanceClientProviderNew(
      const std::shared_ptr<TestInstanceClientOptions>& test_options)
      : TestInstanceClientProviderNew(test_options) {}
