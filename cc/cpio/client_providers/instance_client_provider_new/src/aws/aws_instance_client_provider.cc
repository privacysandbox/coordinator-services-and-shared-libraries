...
using google::scp::core::errors::
    SC_AWS_INSTANCE_CLIENT_PROVIDER_NEW_RESPONSE_MALFORMED;
...
namespace {
constexpr char kAwsInstanceClientProviderNew[] = "AwsInstanceClientProviderNew";
...
ExecutionResult AwsInstanceClientProviderNew::Init() noexcept {
  return SuccessExecutionResult();
}

ExecutionResult AwsInstanceClientProviderNew::Run() noexcept {
  return SuccessExecutionResult();
}

ExecutionResult AwsInstanceClientProviderNew::Stop() noexcept {
  return SuccessExecutionResult();
}

ExecutionResultOr<shared_ptr<EC2Client>>
AwsInstanceClientProviderNew::GetEC2ClientByRegion(
...
ExecutionResult
AwsInstanceClientProviderNew::GetCurrentInstanceResourceNameSync(
  ...
  auto execution_result =
      CpioUtils::AsyncToSync<GetCurrentInstanceResourceNameRequest,
                             GetCurrentInstanceResourceNameResponse>(
          bind(&AwsInstanceClientProviderNew::GetCurrentInstanceResourceName,
               this, _1),
          request, response);

  if (!execution_result.Successful()) {
    ERROR(kAwsInstanceClientProviderNew, kZeroUuid, kZeroUuid, execution_result,
...
ExecutionResult AwsInstanceClientProviderNew::GetCurrentInstanceResourceName(
  ...
  AsyncContext<GetSessionTokenRequest, GetSessionTokenResponse>
      get_token_context(
          ...
          bind(&AwsInstanceClientProviderNew::OnGetSessionTokenCallback, this,
  ...
  if (!execution_result.Successful()) {
    ...
    ERROR_CONTEXT(kAwsInstanceClientProviderNew, get_resource_name_context,
...
void AwsInstanceClientProviderNew::OnGetSessionTokenCallback(
    AsyncContext<GetCurrentInstanceResourceNameRequest,
                 GetCurrentInstanceResourceNameResponse>&
  ...
  AsyncContext<HttpRequest, HttpResponse> http_context(
      move(signed_request),
      bind(&AwsInstanceClientProviderNew::OnGetInstanceResourceNameCallback,
...
void AwsInstanceClientProviderNew::OnGetInstanceResourceNameCallback(
    AsyncContext<GetCurrentInstanceResourceNameRequest,
                 GetCurrentInstanceResourceNameResponse>&
        get_resource_name_context,
  ...
  if (!all_of(GetRequiredFieldsForInstanceDynamicData().first,
    ...
    ERROR_CONTEXT(
        kAwsInstanceClientProviderNew, get_resource_name_context,
        malformed_failure,
...
ExecutionResult
AwsInstanceClientProviderNew::GetInstanceDetailsByResourceNameSync(
  ...
  auto execution_result =
      CpioUtils::AsyncToSync<GetInstanceDetailsByResourceNameRequest,
                             GetInstanceDetailsByResourceNameResponse>(
          bind(&AwsInstanceClientProviderNew::GetInstanceDetailsByResourceName,
               this, _1),
          request, response);
...
ExecutionResult AwsInstanceClientProviderNew::GetInstanceDetailsByResourceName(
  ...
  if (!execution_result.Successful()) {
    ...
    ERROR_CONTEXT(
        kAwsInstanceClientProviderNew, get_details_context,
  ...
  (*ec2_client_or)
      ->DescribeInstancesAsync(
          request,
          bind(&AwsInstanceClientProviderNew::OnDescribeInstancesAsyncCallback,
               this, get_details_context, _1, _2, _3, _4));

  return SuccessExecutionResult();
}

void AwsInstanceClientProviderNew::OnDescribeInstancesAsyncCallback(
    AsyncContext<GetInstanceDetailsByResourceNameRequest,
  ...
  if (!outcome.IsSuccess()) {
    ...
    ERROR_CONTEXT(
        kAwsInstanceClientProviderNew, get_details_context, result,
  ...
  if (outcome.GetResult().GetReservations().size() != 1 ||
    ...
    auto execution_result = FailureExecutionResult(
        SC_AWS_INSTANCE_CLIENT_PROVIDER_NEW_RESPONSE_MALFORMED);
    ERROR_CONTEXT(
        kAwsInstanceClientProviderNew, get_details_context, execution_result,
...
ExecutionResult AwsInstanceClientProviderNew::GetTagsByResourceName(
  ...
  if (!execution_result.Successful()) {
    ...
    ERROR_CONTEXT(kAwsInstanceClientProviderNew, get_tags_context,
  ...
  if (!ec2_client_or.Successful()) {
    ...
    ERROR_CONTEXT(
        kAwsInstanceClientProviderNew, get_tags_context,
        get_tags_context.result,
        "Get tags request failed to create EC2Client for resource name %s",
        get_tags_context.request->resource_name().c_str());
    get_tags_context.Finish();
  ...
  (*ec2_client_or)
      ->DescribeTagsAsync(
          request,
          bind(&AwsInstanceClientProviderNew::OnDescribeTagsAsyncCallback, this,
               get_tags_context, _1, _2, _3, _4));
  return SuccessExecutionResult();
}

void AwsInstanceClientProviderNew::OnDescribeTagsAsyncCallback(
    AsyncContext<GetTagsByResourceNameRequest, GetTagsByResourceNameResponse>&
        get_tags_context,
  ...
  if (!outcome.IsSuccess()) {
    ...
    auto result = EC2ErrorConverter::ConvertEC2Error(
        error_type, outcome.GetError().GetMessage());
    ERROR_CONTEXT(kAwsInstanceClientProviderNew, get_tags_context, result,
...
InstanceClientProviderFactory::Create(
  ...
  return make_shared<AwsInstanceClientProviderNew>(
