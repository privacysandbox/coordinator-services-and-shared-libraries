...
/// Registers component code as 0x0210 for AwsInstanceClientProviderNew.
REGISTER_COMPONENT_CODE(SC_AWS_INSTANCE_CLIENT_PROVIDER_NEW, 0x021B)

DEFINE_ERROR_CODE(SC_AWS_INSTANCE_CLIENT_PROVIDER_NEW_RESPONSE_MALFORMED,
                  SC_AWS_INSTANCE_CLIENT_PROVIDER_NEW, 0x0001,
...
DEFINE_ERROR_CODE(
    ...
    SC_AWS_INSTANCE_CLIENT_PROVIDER_NEW, 0x0002,
...
DEFINE_ERROR_CODE(SC_AWS_INSTANCE_CLIENT_INVALID_INSTANCE_RESOURCE_NAME,
                  SC_AWS_INSTANCE_CLIENT_PROVIDER_NEW, 0x0003,
                  "Invalid aws resource name", HttpStatusCode::BAD_REQUEST)
DEFINE_ERROR_CODE(SC_AWS_INSTANCE_CLIENT_INVALID_REGION_CODE,
                  SC_AWS_INSTANCE_CLIENT_PROVIDER_NEW, 0x0004,
                  "Invalid aws region code", HttpStatusCode::BAD_REQUEST)

MAP_TO_PUBLIC_ERROR_CODE(SC_AWS_INSTANCE_CLIENT_PROVIDER_NEW_RESPONSE_MALFORMED,
