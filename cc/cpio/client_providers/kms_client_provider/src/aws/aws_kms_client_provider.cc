...
#include "aws_kms_client_provider.h"
...
static constexpr char kAwsKmsClientProvider[] = "AwsKmsClientProvider";
static constexpr int kKeyArnPrefixSize = 10;

namespace google::scp::cpio::client_providers {

ExecutionResult AwsKmsClientProvider::Init() noexcept {
...
ExecutionResult AwsKmsClientProvider::Run() noexcept {
  return SuccessExecutionResult();
}

ExecutionResult AwsKmsClientProvider::Stop() noexcept {
  return SuccessExecutionResult();
}

ExecutionResult AwsKmsClientProvider::Decrypt(
  ...
  AsyncContext<KmsDecryptRequest, Aead> get_aead_context(
      ...
      bind(&AwsKmsClientProvider::GetAeadCallbackToDecrypt, this,
           decrypt_context, _1));
  return GetAead(get_aead_context);
}

ExecutionResult AwsKmsClientProvider::GetAeadCallbackToDecrypt(
...
ExecutionResult AwsKmsClientProvider::GetAead(
    AsyncContext<KmsDecryptRequest, Aead>& get_aead_context) noexcept {
  AsyncContext<KmsDecryptRequest, KMSClient> create_kms_context(
      get_aead_context.request,
      bind(&AwsKmsClientProvider::CreateKmsCallbackToCreateAead, this,
           get_aead_context, _1));
  return CreateKmsClient(create_kms_context);
}

void AwsKmsClientProvider::CreateKmsCallbackToCreateAead(
    AsyncContext<KmsDecryptRequest, Aead>& get_aead_context,
...
ExecutionResult AwsKmsClientProvider::CreateKmsClient(
    AsyncContext<KmsDecryptRequest, KMSClient>& create_kms_context) noexcept {
  ...
  AsyncContext<GetRoleCredentialsRequest, GetRoleCredentialsResponse>
      get_role_credentials_context(
          move(request),
          bind(&AwsKmsClientProvider::GetSessionCredentialsCallbackToCreateKms,
               this, create_kms_context, _1));
  return role_credentials_provider_->GetRoleCredentials(
      get_role_credentials_context);
}

void AwsKmsClientProvider::GetSessionCredentialsCallbackToCreateKms(
    AsyncContext<KmsDecryptRequest, KMSClient>& create_kms_context,
    AsyncContext<GetRoleCredentialsRequest, GetRoleCredentialsResponse>&
...
shared_ptr<KMSClient> AwsKmsClientProvider::GetKmsClient(
