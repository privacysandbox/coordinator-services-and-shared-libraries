...
#include "cc/cpio/client_providers/kms_client_provider/src/aws/aws_kms_aead.h"
...
#include "cc/cpio/client_providers/kms_client_provider/mock/aws/mock_kms_client.h"
