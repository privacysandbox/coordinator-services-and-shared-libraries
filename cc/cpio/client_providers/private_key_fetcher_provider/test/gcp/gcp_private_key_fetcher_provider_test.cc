...
#include "cc/cpio/client_providers/private_key_fetcher_provider/src/gcp/gcp_private_key_fetcher_provider.h"
...
#include "cc/cpio/client_providers/private_key_fetcher_provider/src/gcp/error_codes.h"
