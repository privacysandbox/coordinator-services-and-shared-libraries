...
DEFINE_ERROR_CODE(SC_CONFIG_CLIENT_PROVIDER_PARAMETER_NOT_FOUND,
                  SC_CONFIG_CLIENT_PROVIDER, 0x0002, "Parameter not found",
                  HttpStatusCode::BAD_REQUEST)

MAP_TO_PUBLIC_ERROR_CODE(SC_CONFIG_CLIENT_PROVIDER_TAG_NOT_FOUND,
                         SC_CPIO_ENTITY_NOT_FOUND)
MAP_TO_PUBLIC_ERROR_CODE(SC_CONFIG_CLIENT_PROVIDER_PARAMETER_NOT_FOUND,
