...
/*! @copydoc PrivateKeyFetchingClientProviderInterface
 */
class PrivateKeyFetchingClientProvider
    : public PrivateKeyFetchingClientProviderInterface {
 public:
  virtual ~PrivateKeyFetchingClientProvider() = default;

  explicit PrivateKeyFetchingClientProvider(
 ...
 protected:
  ...
  virtual core::ExecutionResult SignHttpRequest(
      ...
      const std::shared_ptr<AccountIdentity>& account_identity) noexcept = 0;
