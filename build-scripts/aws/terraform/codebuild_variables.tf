...
variable "coordinator_services_git_repo" {
  type        = string
  description = "Coordinator Services CodeCommit repository location"
}

variable "coordinator_services_git_repo_branch" {
  type        = string
  description = "Coordinator Services Git repository branch"
  default     = ""
}
